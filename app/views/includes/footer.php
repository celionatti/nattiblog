        ...
        <div class="row g-3">
            <div class="col-6 col-md-2 mb-3">
                ...
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item mb-2"><a href="<?= ROOT ?>blogs" class="nav-link p-0 text-muted">News</a></li>
                </ul>
            </div>
            ...
            <div class="col-6 col-md-2 mb-3">
                ...
                <ul class="nav flex-column">
                    <li class="nav-item mb-2"><a href="<?= ROOT ?>pages/report" class="nav-link p-0 text-muted">Report a
                            story</a></li>
                    <li class="nav-item mb-2"><a href="<?= ROOT ?>pages/advertisement"
                            class="nav-link p-0 text-muted">Advertisement</a></li>
